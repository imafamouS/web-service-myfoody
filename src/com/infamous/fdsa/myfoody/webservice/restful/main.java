...
public class main {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 * File("D:/img/1.jpg")); byte[] byteArray =
		 * IOUtils.toByteArray(inputStream);
		 * 
		 * String str =Base64.getEncoder().encodeToString(byteArray); JsonObject
		...
		/*
		 * URL url = new
		 * URL("http://localhost:9080/MyFoodyWebService/rest/api/menubar/post");
		 ...
		 * out.write(object.toString()); out.close();
		 * 
		 * // read the response InputStream in = new
		 * BufferedInputStream(connection.getInputStream()); String result =
		 * org.apache.commons.io.IOUtils.toString(in, "UTF-8"); JSONObject
		 * jsonObject = new JSONObject(result);
		 * 
		 * in.close(); System.out.println(jsonObject);
		 */
		 ...
		 *//*
			 ...
			 * 
			 * URL url = new
			 * URL("http://localhost:9080/MyFoodyWebService/rest/login");
			 * URLConnection connection = url.openConnection();
			 * connection.setDoOutput(true);
			 * connection.setRequestProperty("Content-Type",
			 * "application/json"); connection.setConnectTimeout(5000);
		...
		/*
		 * URL url = new URL(
		 * "http://localhost:9080/MyFoodyWebService/rest/api/menubar/get/category_what2do"
		 * ); URLConnection connection = url.openConnection();
		 * connection.setDoOutput(true);
		 * connection.setRequestProperty("Content-Type", "application/json");
		 * connection.setConnectTimeout(5000); connection.setReadTimeout(5000);
		 ...
		 */
		System.out.println(LocatorUtil.calculateDistance(10000.0, 100.0, 1.0, 1000.0));
	}
